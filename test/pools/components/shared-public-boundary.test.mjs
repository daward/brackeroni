...
const internalImportMarker = ["components", "pools", "shared", "internal"].join("/");
const sharedDirectory = path.join(rootDirectory, "components", "pools", "shared");
...
test("pool shared internals are not imported outside the shared feature", () => {
...
test("shared pool UI keeps only its public API at the feature root", () => {
