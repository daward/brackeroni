...
const internalImportMarker = ["components", "pools", "management", "internal"].join("/");
const managementDirectory = path.join(rootDirectory, "components", "pools", "management");
...
test("pool management internals are not imported outside the feature", () => {
...
test("pool management keeps only its public API at the feature root", () => {
