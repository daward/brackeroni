...
import { usePaginatedCollection } from "@/components/shared/use-paginated-collection";
...
export function usePaginatedCandidates({ poolId, candidates, pagination }) {
  ...
  return { candidates: collection.items, hasNextPage: collection.hasNextPage, isLoadingMore: collection.isLoadingMore, loadMore: collection.loadMore };
}
