...
export async function recordTournamentVote({
  ...
  return sql.begin(async (tx) => {
    ...
    const existingAnonymousVote = existing.find(
      (vote) => vote.anonymousVoterToken && typedAnonymousVoterToken && vote.anonymousVoterToken === typedAnonymousVoterToken
    );
...
export async function applyTournamentLifecyclePatch({ tournamentId, creatorUserId, patch }) {
