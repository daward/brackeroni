...
import type { BracketAudienceMode, BracketStatus, BracketVisibility, ManagedBracket, ParallelBracketSource } from "./types";

type BracketAudienceSource = Pick<ManagedBracket, "sharingMode" | "visibility">;
...
export function getTournamentAudiencePatch(audienceMode: BracketAudienceMode): Pick<ManagedBracket, "sharingMode" | "visibility"> {
...
export function buildDirectBracketSharePath(tournament?: Pick<ManagedBracket, "id" | "status" | "kind"> | null) {
...
export function normalizeParallelBracketItem(item: ParallelBracketSource): ManagedBracket {
  return {
    ...item,
...
export function sortManagedBrackets<T extends Pick<ManagedBracket, "status" | "createdAt">>(items: T[]) {
